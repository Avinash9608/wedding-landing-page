...
// const Contact = () => {
//   const email = "example@gmail.com"; // This can be fetched dynamically
//   const phone = "+1 234 567 890"; // Example phone number

//   return (
//     <>
//     <div className="bg-orange-400 mb-6">
//     <Navbar/>
//     </div>
...
//                   <input
//                     type="text"
//                     className="w-full rounded border-2 px-3 py-2 outline-none focus:border-sky-500"
...
//                   <input
//                     type="checkbox"
//                     className="h-5 w-5 border-gray-300 rounded focus:ring-2 focus:ring-sky-500"
//                     id="sendCopy"
//                   />
//                   <label
//                     htmlFor="sendCopy"
...
//                 <button
//                   type="button"
//                   className="w-full rounded bg-sky-500 text-white px-6 py-2 text-sm font-medium uppercase hover:bg-sky-600"
//                 >
//                   Send
//                 </button>
//               </form>
...
//               <div className="flex flex-wrap">
//                 <div className="mb-12 md:w-6/12 lg:w-full xl:w-6/12">
//                   <div className="flex items-start">
//                     <div className="p-4 rounded-md bg-sky-200 text-sky-600">
//                       <svg
...
//                     </div>
//                     <div className="ml-6">
//                       <p className="mb-2 font-bold text-gray-800">Technical Support</p>
...
//                       <p className="text-sm text-gray-500">Punpun, Near Parsa Bazar</p>
//                       <p className="text-sm text-gray-500">Bihar</p>
//                     </div>
//                   </div>
//                 </div>
//                 <div className="mb-12 md:w-6/12 lg:w-full xl:w-6/12">
...
//                     </div>
//                     <div className="ml-6">
//                       <p className="mb-2 font-bold text-gray-800">LandLine</p>
//                       <p className="text-sm text-gray-500">(0612) 431 2030</p>
...
//                     </div>
//                     <div className="ml-6">
//                       <p className="mb-2 font-bold text-gray-800">Mobile</p>
//                       <p className="text-sm text-gray-500"></p>
//                       <p className="text-sm text-gray-500">{phone}</p>
//                     </div>
//                   </div>
...
const Contact = () => {
  ...
  return (
    <>
      ...
      <section className="mb-32">
        {/* Map Section */}
        <div id="map" className="relative h-[300px] bg-cover bg-no-repeat">
          <iframe
        ...
        <div className="container px-6 md:px-12">
          <div className="block rounded-lg bg-white bg-opacity-80 px-6 py-12 shadow-lg md:py-16 md:px-12 -mt-[100px] backdrop-blur-md border border-gray-300">
            <div className="flex flex-wrap">
              {/* Form Section */}
              <div className="mb-12 w-full md:w-5/12">
